...
- **Ind:** $\quad \forall \vec{y} \: ( \varphi(0,\vec{y}) \, \wedge \, \forall x (\varphi(x,\vec{y}) \to \varphi(x+1,,\vec{y})) \to \forall x \; \varphi(x,\vec{y})$
...
2. Show that if $\mathcal{M} \models \mathsf{PA}^{-}$ is non-standard and has the property that for any proper cut $I$ there is $c > I$ in $M$ such that $\mathcal{M} \models \forall x \leq c \: \varphi(x,\vec{a})$ (i.e., $\mathcal{M}$ satisfies the conclusion of (1.)), then $\mathcal{M} \models \mathsf{PA}$.
