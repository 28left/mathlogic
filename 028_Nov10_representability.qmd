...
$$
\varphi(\vec{x},y, z) \wedge \forall u,v \le y+z \; (u+v < y+z \to \neg \varphi(\vec{x},u, v)).
$$

We now claim that the $\Sigma_1$-formula $\exists z \; \psi(\vec{x},y, z)$ represents the function $f$ in $T$:
